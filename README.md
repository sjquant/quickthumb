...
![Editorial launch announcement example built with bold typography, auto-layout groups, theme tokens, and a star shape](examples/launch_announcement.png)
...
- `examples/launch_announcement.py` — an editorial release poster using groups, theme tokens, shapes, grain, and diagnostics in one JSON spec
